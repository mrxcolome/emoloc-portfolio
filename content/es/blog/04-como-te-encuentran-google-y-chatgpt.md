---
título: cómo te encuentran Google y ChatGPT, y qué puedes hacer
pilar: comunicación
entradilla: Cada vez más gente pregunta a un asistente de IA "qué escuela de danza me recomiendas en Sant Gervasi". Si tu web no se puede leer, no saldrás.
fecha: 2026-09
---

Durante veinte años, ser encontrado significaba salir en Google. Sigue siendo así, pero ya no es el único camino. Cada vez más gente abre ChatGPT, Gemini o el asistente del móvil y pregunta directamente: "qué despacho me recomiendas para esto", "qué escuela hay cerca de casa que dé clases para adultos". Y el asistente responde con dos o tres nombres.
...
**Si la web se puede leer bien.** Rápida, que funcione en el móvil, con una estructura clara: una página por cada cosa que haces, con un título que diga qué es.

**Si responde a lo que la gente busca.** Una página que se llama "clases de hip-hop para niños en Sant Gervasi" y que explica horarios, edades y precios responde mejor que una que se llama "actividades".
...
- **La información es explícita.** "Clases desde los 3 años", "abierto los sábados por la mañana", "primera clase de prueba gratuita". Nada de sobreentendidos.
- **La web tiene datos estructurados.** Una capa de código, invisible para la persona, que le dice a la máquina "esto es una escuela, esta es la dirección, estos son los horarios".
...
En la Escuela de danza Cristina Colomé, quince días después de arrancar el seguimiento, la web había pasado de 111 a 143 páginas en Google y de la posición media 28,7 a la 10,9. Primera página para "escola de dansa". [enlace al caso]
