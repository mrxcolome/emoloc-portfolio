---
título: vender conocimiento por suscripción: qué hace falta de verdad
pilar: venta
entradilla: Tienes veinte años de oficio y te dicen que hagas "un curso online". La idea es buena, pero una plataforma de membresía es bastante más que colgar vídeos.
fecha: 2026-09
---
...
**Aprender.** Cursos con progreso, "continúa donde lo dejaste" y recomendaciones según el perfil de cada uno.

**Consultar.** Guías, plantillas, listas de comprobación, casos. Cosas que el alumno vuelve a buscar cuando tiene un problema concreto. Con un buscador que las encuentre aunque escriba sin acentos.

**Estar al día.** Contenido nuevo de manera constante: noticias del sector comentadas, sesiones en directo con reserva de plaza, respuestas a preguntas. Es lo que evita las bajas.

Y detrás, cuatro cosas que no se ven pero lo sostienen todo:

- **Pago recurrente bien hecho.** Alta inmediata, facturas automáticas, portal para que el alumno gestione su suscripción sin escribirte.
- **Una sala de profesores.** Un sitio donde tú publiques un curso o una pieza en cinco pasos, sin tocar nada técnico y sin depender de nadie.
...
1. **Un plan de contenidos para los primeros seis meses.** No hace falta tenerlo todo grabado, hace falta saber qué vendrá.
...
- **Decide un precio y dilo en voz alta a tres personas.** Si no ponen cara rara, es bueno.

Para Brachfield Academy construimos todo esto entero: sitio público, pagos, zona de alumnos, tablón de noticias automático y sala de profesores, con un único plan de 39 € al mes. [enlace al caso]
