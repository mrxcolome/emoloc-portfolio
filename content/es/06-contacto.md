...
2. **empresa** · texto · obligatorio
3. **email** · email · obligatorio
4. **teléfono** · texto · opcional · ayuda: "si prefieres que te llame"
5. **¿dónde te duele?** · casillas, se puede marcar más de una:
   - presencia (web, marca, contenido)
   - gestión (herramientas internas, excels)
   - venta (tienda en línea, membresía, formación)
   - comunicación (Google, Meta, email, SEO)
   - no lo sé, por eso escribo
6. **cuéntamelo** · texto largo · obligatorio · ayuda: "qué haces, qué te pasa y qué te gustaría que pasara"
7. **consentimiento** · casilla obligatoria: "He leído la política de privacidad y acepto que emoloc use estos datos para responderme."
8. **[botón]** enviar
...
Gracias por escribir. He recibido tu mensaje sobre [empresa] y lo leeré con calma. Te respondo en uno o dos días laborables.

Si mientras tanto se te ocurre algo más, responde a este mismo email.
...
Cuerpo: todos los campos del formulario, más fecha y hora, idioma de la web desde donde se ha enviado y página de origen.
